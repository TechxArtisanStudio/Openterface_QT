...
// Public accessor methods for protected constants
QString AbstractPlatformDeviceManager::getSerialVid()
{
    return SERIAL_VID;
}

QString AbstractPlatformDeviceManager::getSerialPid()
{
    return SERIAL_PID;
}

QString AbstractPlatformDeviceManager::getOpenterfaceVid()
{
    return OPENTERFACE_VID;
}

QString AbstractPlatformDeviceManager::getOpenterfacePid()
{
    return OPENTERFACE_PID;
}

QString AbstractPlatformDeviceManager::getSerialVidV2()
{
    return SERIAL_VID_V2;
}

QString AbstractPlatformDeviceManager::getSerialPidV2()
{
    return SERIAL_PID_V2;
}

QString AbstractPlatformDeviceManager::getOpenterfaceVidV2()
{
    return OPENTERFACE_VID_V2;
}

QString AbstractPlatformDeviceManager::getOpenterfacePidV2()
{
    return OPENTERFACE_PID_V2;
}

QString AbstractPlatformDeviceManager::getSerialVidV3()
{
    return SERIAL_VID_V3;
}

QString AbstractPlatformDeviceManager::getSerialPidV3()
{
    return SERIAL_PID_V3;
}

QString AbstractPlatformDeviceManager::getOpenterfaceVidV3()
{
    return OPENTERFACE_VID_V3;
}

QString AbstractPlatformDeviceManager::getOpenterfacePidV3()
{
    return OPENTERFACE_PID_V3;
}
