...
// Version Registers
const uint16_t MS2130S_ADDR_FIRMWARE_VERSION_0 = 0x1FC0;
const uint16_t MS2130S_ADDR_FIRMWARE_VERSION_1 = 0x1FC1;
const uint16_t MS2130S_ADDR_FIRMWARE_VERSION_2 = 0x1FC2;
const uint16_t MS2130S_ADDR_FIRMWARE_VERSION_3 = 0x1FC3;
