...
QPair<int, int> VideoHid::getResolution() {
    quint32 width_h = static_cast<quint32>(usbXdataRead4Byte(0xC738).first.at(0));
    quint32 width_l = static_cast<quint32>(usbXdataRead4Byte(0xC739).first.at(0));
    quint32 width = (width_h << 8) + width_l;
    quint32 height_h = static_cast<quint32>(usbXdataRead4Byte(0xC73A).first.at(0));
    quint32 height_l = static_cast<quint32>(usbXdataRead4Byte(0xC73B).first.at(0));
    quint32 height = (height_h << 8) + height_l;
